...
namespace WordPress\CommandCodeAiProvider\Tests {
...
namespace {
    ...
    if (!function_exists('apply_filters')) {
        ...
        {
            \WordPress\CommandCodeAiProvider\Tests\WpFilterTestDouble::addFilter($tag, $callback);
        }
        ...
        {
            \WordPress\CommandCodeAiProvider\Tests\WpFilterTestDouble::removeAllFilters($tag);
        }
        ...
        {
            return \WordPress\CommandCodeAiProvider\Tests\WpFilterTestDouble::applyFilters($tag, $value);
        }
    }
}
